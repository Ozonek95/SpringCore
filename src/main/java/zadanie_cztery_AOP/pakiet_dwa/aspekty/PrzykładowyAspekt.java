...
class PrzykładowyAspekt {
  ...
  @Pointcut("within(zadanie_cztery_AOP.pakiet_dwa.zwierzaki.*)")
  void zwierzaki() {
  }

  @Pointcut("within(zadanie_cztery_AOP.pakiet_dwa.samochody.*)")
  void samochody(){
  }

  @Pointcut("within(zadanie_cztery_AOP.pakiet_dwa.człowieki.*)")
  void człowieki() {
  }
  ...
  @Pointcut("execution(* zadanie_cztery_AOP.pakiet_dwa.samochody.*.set*(..))")
  void setterySamochodów(){}

  @Pointcut("execution(* zadanie_cztery_AOP.pakiet_dwa.zwierzaki.Pies.get*(..))")
  void getterPsa(){}
}
