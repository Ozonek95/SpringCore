package zadanie_cztery_AOP.b_pointcut_expressions.aspekty;
...
class PrzykładowyAspekt {
  ...
  @Pointcut("within(zadanie_cztery_AOP.b_pointcut_expressions.zwierzaki.*)")
  void zwierzaki() {
  }

  @Pointcut("within(zadanie_cztery_AOP.b_pointcut_expressions.samochody.*)")
  void samochody(){
  }

  @Pointcut("within(zadanie_cztery_AOP.b_pointcut_expressions.człowieki.*)")
  void człowieki() {
  }

  @Pointcut("within(zadanie_cztery_AOP..*)")
  void całyPakiet(){
  }

  @Pointcut("zwierzaki() || człowieki()")
  void żyweIstoty(){
  }

  @Pointcut("execution(* zadanie_cztery_AOP.b_pointcut_expressions.samochody.*.set*(..))")
  void setterySamochodów(){}

  @Pointcut("execution(* zadanie_cztery_AOP.b_pointcut_expressions.zwierzaki.Pies.get*(..))")
  void getterPsa(){}
}
