...
class PrzykładowyAspekt {
  ...
  @Pointcut("within(zadanieCzwarteAOP.pakiet_dwa.samochody.*)")
  void samochody(){
  }
  ...
  @Pointcut("execution(* zadanieCzwarteAOP.pakiet_dwa.samochody.*.set*(..))")
  void setterySamochodów(){}

  @Pointcut("execution(* zadanieCzwarteAOP.pakiet_dwa.zwierzaki.Pies.get*(..))")
  void getterPsa(){}
}
